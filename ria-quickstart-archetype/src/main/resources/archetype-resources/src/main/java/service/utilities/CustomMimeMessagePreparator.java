package ${package}.service.utilities;
...
/**
 * Email message preparator used by this application. Immutable and Thread Safe.
 * 
...
public class CustomMimeMessagePreparator implements MimeMessagePreparator {
	...
	/**
	 * Instantiates a new CustomMimeMessagePreparator.
	 *
	 * @param sender
	 *            the {@link #sender}
	 * @param recipient
	 ...
	 *            the {@link #text}
	 */
	public CustomMimeMessagePreparator(String sender, String recipient, String subject, String text) {
		this.sender = sender;
